...
const randomStars = Array(1).fill(1).map(() => ({
  //  (window.innerWidth-200, -100) prevents the star from goind outside (right, left) the screen
  x: Math.random() * (window.innerWidth - 100 + 1) - 100, // -200+100 to include negative numbers
...
console.log('random window.innerXXX:', randomStars[0]);
console.log('window.innerWidth: ', window.innerWidth, 'window.innerHeight', window.innerHeight);
